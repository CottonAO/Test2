...
<head>
    ...
    <title>Активный теста</title>
</head>
<body class="test-layout bg-blue-100">
        ...
        <div class="container-fluid">
            <div class="header-top">
                ...
                <div class="header-actions">
                                            <div class="timer">
                            <img src="images/timer-icon.svg" alt="Timer icon">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content px-6 py-8" style="max-width: 348px;">
            ...
            <!-- Если в ответе есть картинка -->
                    ...
                    <img src="images/answer-picture.jpg" alt="answer illustration">
                </div>
